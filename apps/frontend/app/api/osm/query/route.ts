/**
 * GET /api/osm/query
 * Queries the Overpass API for POIs (cafes, fuel, parking, etc.) within a bounding box.
 * Query params: lat, lng (required), radius_km, amenity, custom_query.
 * Returns: { count, features: Array<{ id, type, lat, lon, tags }>, bbox }
 */
